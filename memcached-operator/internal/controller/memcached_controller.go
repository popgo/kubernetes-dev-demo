...
// +kubebuilder:rbac:groups=cache.popgo.domain,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.popgo.domain,resources=memcacheds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cache.popgo.domain,resources=memcacheds/finalizers,verbs=update
